...
## CONTRIBUTION GUIDE FOR AQUILA FOR FRONTEND TEAM
-----------------------------------------------

#### TO CONTRIBUTE

- Create a personal fork of the project repo on [Github](https://github.com/)
...
- On your local system inside the cloned project, add the original repository as a remote called upstream.
  ...
  `git remote add upstream git@github.com:aquilabyeth/falcon-FE.git/`
...
- Use gitignore for unnecessary file like node module
...
- If there are conflicts, please resolve them before opening a pull request

- Pull from upstream before pushing your code to the develop branch
